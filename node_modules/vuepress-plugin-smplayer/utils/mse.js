...
export const m3u8 = async (mediaElement, src, player, onDestroy = "destroy") => {
    const { default: Hls } = await import("hls.js/dist/hls.min.js");
    if (mediaElement.canPlayType("application/x-mpegURL") ||
...
export const flv = async (mediaElement, src, player, onDestroy = "destroy") => {
...
export const dash = async (mediaElement, src, player, onDestroy = "destroy") => {
