export default class ArtplayerVue {
    ...
    async InitPlayer() {
        if (this.src) {
            return await import(
            /* webpackChunkName: "artplayer" */ "artplayer/dist/artplayer.js").then(async ({ default: artplayer }) => {
                let useHls = false;
                let useFlv = false;
                let useDash = false;
                ...
                if (useHls) {
                    Object.assign(this.src?.customType, {
                        smplayerArtplayerHls: function (video, url, player) {
                ...
                if (useFlv) {
                    Object.assign(this.src?.customType, {
                        smplayerArtplayerFlv: function (video, url, player) {
                            import(
                ...
                if (useDash) {
                    Object.assign(this.src?.customType, {
                        smplayerArtplayerDash: function (video, url, player) {
                            import(
                ...
                if (useShakaDash) {
                    Object.assign(this.src?.customType, {
                        smplayerArtplayerShakaDash: function (video, url, player) {
                            import(
                ...
                if (useWebtorrent) {
                    Object.assign(this.src?.customType, {
                        smplayerArtplayerWebtorrent: function (video, url, player) {
                            import(
