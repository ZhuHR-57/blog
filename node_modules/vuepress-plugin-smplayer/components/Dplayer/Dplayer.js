export default class Dplayer {
    ...
    async InitPlayer() {
        if (this.src) {
            return await import(
            /* webpackChunkName: "dplayer" */ "dplayer/dist/DPlayer.min.js").then(async ({ default: dplayer }) => {
                let useHls = false;
                let useFlv = false;
                let useDash = false;
                ...
                if (this.src?.video?.quality != undefined &&
                    this.src.video.quality.length > 0) {
                    this.src.video.quality.forEach((e) => {
                        // .m3u8 和 .flv 结尾的视频
                        if (e.type == undefined) {
                ...
                if (useHls) {
                    Object.assign(this.src?.video?.customType, {
                        smplayerDplayerHls: function (video, player) {
                            import(/* webpackChunkName: "hls" */ "hls.js/dist/hls.js").then(({ default: Hls }) => {
                                let src = video.src;
                                const hls = new Hls();
                ...
                if (useFlv) {
                    Object.assign(this.src?.video?.customType, {
                        smplayerDplayerFlv: function (video, player) {
                            import(
                            /* webpackChunkName: "mpegts" */ "mpegts.js/dist/mpegts.js").then(({ default: mpegts }) => {
                ...
                if (useDash) {
                    Object.assign(this.src?.video?.customType, {
                        smplayerDplayerDash: function (video, player) {
                            import(
                            /* webpackChunkName: "dash" */ "dashjs/dist/dash.all.min.js").then(({ default: dashjs }) => {
                ...
                if (useShakaDash) {
                    Object.assign(this.src?.video?.customType, {
                        smplayerDplayerShakaDash: function (video, player) {
                            import(
                            /* webpackChunkName: "shaka-player" */ "shaka-player/dist/shaka-player.compiled.js").then(({ default: shaka }) => {
                ...
                if (useWebtorrent) {
                    Object.assign(this.src?.video?.customType, {
                        smplayerDplayerWebtorrent: function (video, player) {
                            import(
                            /* webpackChunkName: "webtorrent" */ "webtorrent/webtorrent.min.js").then(({ default: WebTorrent }) => {
